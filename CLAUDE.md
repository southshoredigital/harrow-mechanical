...
- **`fontSize.hero` numbers are display statements, not data, and are set in the display face rather than mono.** The project count on the homepage and the founding year on the about page. That is the only exception to the mono rule.
